...
const AngularCompilerPlugin = require('@ngtools/webpack'); // Aot instead
...
const { AotPlugin } = require('@ngtools/webpack'); // angular 5 use AngularCompilerPlugin instead of AotPlugin
        ...
        "rules": [
            ...
            },
            {
                "exclude": [
                    ...
                    path.join(process.cwd(), "src\\assets\\sass\\material-dashboard.scss"),
