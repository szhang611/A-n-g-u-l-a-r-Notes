        ...
        />
          {
            ...
            <Controls
                ...
                displayReplayButton={displayReplayButton}
                displayControlBar={displayControlBar}
                pressEditIcon={()=>this.props.pressEditIcon()}
                replayClippedVideo={()=>this.props.replayClippedVideo()}
            />
          }
...
Video.propTypes = {
  ...
  resizeMode: PropTypes.string,
    ...
    replayClippedVideo: PropTypes.func,
    displayControlBar: PropTypes.bool,
    displayReplayButton: PropTypes.bool,
};
